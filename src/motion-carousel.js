...
import {motionCarouselStyles} from "./styles.js";
...
export class MotionCarousel extends LitElement {
    ...
    static styles = motionCarouselStyles;
    get selectedSLot() {
    ...
    clickHandler(e) {
        const idx = this.selected + (Number(!e.shiftKey) || -1);
        this.selected = idx > this.maxSelected ? 0 : idx < 0 ? this.maxSelected : idx;
